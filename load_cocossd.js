...
if (!fs.existsSync(prototxt) || !fs.existsSync(modelFile) || !fs.existsSync(prototxtFaces) || !fs.existsSync(modelFileFaces)) {
  console.log('exiting: could not find ssdcoco models');
  console.log('download the model from: https://drive.google.com/file/d/0BzKzrI_SkD1_dUY1Ml9GRTFpUWc/view');
  console.log('download the model from(for Faces): https://github.com/opencv/opencv_3rdparty/raw/19512576c112aa2c7b6328cb0e8d589a4a90a26d/res10_300x300_ssd_iter_140000_fp16.caffemodel');
  return;
}
